...
(function () {
  ...
  var ArrayProto = Array.prototype; var ObjProto = Object.prototype; var
  ...
  var { toString } = ObjProto;
  var { hasOwnProperty } = ObjProto;
  ...
  _.max = function (obj, iteratee, context) {
    ...
    if (iteratee == null && obj != null) {
      ...
      for (var i = 0, { length } = obj; i < length; i++) {
        value = obj[i];
        if (value > result) {
          result = value;
        }
  ...
  _.bindAll = function (obj) {
    var i; var { length } = arguments; var
      key;
  ...
  _.debounce = function (func, wait, immediate) {
    var timeout; var args; var context; var timestamp; var
      result;
  ...
  _.pick = function (object, oiteratee, context) {
    var result = {}; var obj = object; var iteratee; var
      keys;
