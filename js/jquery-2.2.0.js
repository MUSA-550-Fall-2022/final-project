 ...
 */
  ...
  jQuery.extend({
    ...
    when(subordinate /* , ..., subordinateN */) {
      ...
      var progressValues; var progressContexts; var
        resolveContexts;
 ...
 */
  ...
  function cloneCopyEvent(src, dest) {
    var i; var l; var type; var pdataOld; var pdataCur; var udataOld; var udataCur; var
      events;
 ...
 */
  ...
  function propFilter(props, specialEasing) {
    var index; var name; var easing; var value; var
      hooks;
  ...
  function Animation(elem, properties, options) {
    ...
    var stopped;
    var index = 0;
    var { length } = Animation.prefilters;
  ...
  jQuery.fn.extend({
    ...
    toggleClass(value, stateVal) {
      ...
      return this.each(function () {
        var className; var i; var self; var
          classNames;
